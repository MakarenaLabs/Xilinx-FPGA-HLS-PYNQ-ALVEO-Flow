...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.mul_matrix.autotvin_gmem.dat"
         "c.mul_matrix.autotvin_a.dat"
         "c.mul_matrix.autotvin_b.dat"
         "c.mul_matrix.autotvin_c.dat"
         "c.mul_matrix.autotvout_gmem.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.mul_matrix.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
