...
if {[file isfile mul_matrix.autotvin.dat]} {
	file delete -force mul_matrix.autotvin.dat
}

if {[file isfile mul_matrix.autotvout.dat]} {
	file delete -force mul_matrix.autotvout.dat
}
